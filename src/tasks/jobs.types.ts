...
export type TasksJobs = Record<string, TaskJob>;

type TaskFn = (payload: Record<string, any>) => Promise<void>;
...
export type TasksCrons = TaskCron[];

export type TaskCron = {
  task: string;
  match: string;
};
...
//     const expression = CronExpression[key];
//     const interval = cronParser.parseExpression(expression!);
//     const next = interval.next();
//     console.log(key, expression, next.toDate());
//   }
// };
// main();
